...
public partial class Skeleton : MetroWindow
{
	...
	private async Task CheckForUpdates()
	{
		try
		{
			...
			var response = await client.GetStringAsync("https://raw.githubusercontent.com/dardizzola/LaMuccaRossaVideoDownloader/master/LaMuccaRossaVideoDownloader/latestVersionWithRevision.txt");
			var latestVersion = Version.Parse(response);

			if (latestVersion > GlobalConsts.VERSION)
			{
				var changelog = await client.GetStringAsync("https://raw.githubusercontent.com/dardizzola/LaMuccaRossaVideoDownloader/master/LaMuccaRossaVideoDownloader/changelog.txt");
